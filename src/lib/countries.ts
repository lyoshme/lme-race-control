...
/**
 * Полный список стран ISO 3166-1 alpha-2 с русскими названиями.
 * Флаги рендерятся через CSS-классы пакета `flag-icons` (см. CountryFlag.tsx),
 * поэтому в данных хранится только код и имя.
 */
const RAW: Country[] = [
  ...
  { code: 'CN', name: 'Китай' },
  { code: 'KP', name: 'КНДР (Северная Корея)' },
